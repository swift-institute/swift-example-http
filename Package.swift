...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/swift-institute/swift-example-client.git", branch: "main"),
        ...
        .package(url: "https://github.com/swift-compositions/swift-http-route-derivation.git", branch: "main"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "HTTP Route Derivation", package: "swift-http-route-derivation"),
